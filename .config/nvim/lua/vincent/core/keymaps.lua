...
keymap.set("n", "<leader>>", ":tabm +1<CR>") --  move tab to the right
keymap.set("n", "<leader><", ":tabm -1<CR>") --  move tab to the left
...
keymap.set("n", "<leader>fa", "<cmd>Telescope find_files hidden=true no_ignore=true<cr>") -- find files, including dotfiles
